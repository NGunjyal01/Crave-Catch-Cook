    ...
    return (
        <div className="flex bg-[#ACE2E1] w-[95%] h-[35rem] ml-[2.5%] rounded-[2rem] sm:rounded-[4rem] transition-transform duration-500 ease-in-out" >
            <div className="lg:mt-14 lg:ml-10 lg:px-0">
                ...
                <button className="absolute top-[88%] sm:top-[44%] lg:top-[75%] left-[22%] sm:left-[55%] lg:left-[30%] bg-[#008DDA] text-white rounded-2xl w-40 h-14 flex pl-5 py-4 text-lg lg:hover:scale-105" onClick={handleViewRecipe}>
                    View Recipe 
